...
class MyTraining extends React.Component<any, any> {
        ...
        return (
            <React.Fragment>
                <Row style={{ marginTop: '20px' }}>
                    <Col span={2}>培训名称:</Col>
                    <Col span={6}>
                        <Input style={{ width: 300 }} placeholder="培训名称" />
                    </Col>
                    <Col span={4} style={{ textAlign: 'center' }}>培训状态:</Col>
                    <Col span={12}>
                        <Select defaultValue="培训状态" style={{ width: 300 }}>
