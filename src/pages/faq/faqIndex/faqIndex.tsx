...
import { _listKdg } from '../../../common/api/faq'
import styles from './faqIndex.module.less'
...
class FaqIndexTable extends React.PureComponent<any, IState> {
        ...
        return (
            <React.Fragment>
                <KdgManagePageHeader
                    ...
                    handleCreate={(): void => this.props.history.push('/FAQ/create')}
...
const FaqIndex = Form.create()(withRouter(FaqIndexTable))
