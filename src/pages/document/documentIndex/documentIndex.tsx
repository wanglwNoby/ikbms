...
import { _listKdg } from '../../../common/api/document'
import styles from './documentIndex.module.less'
...
class DocumentIndexTable extends React.PureComponent<any, IState> {
        ...
        return (
            <React.Fragment>
                <KdgManagePageHeader
                    ...
                    handleCreate={(): void => this.props.history.push('/document/create')}
                    handleDelete={this.deleteDocument}
                />
...
const DocumentIndex = Form.create()(withRouter(DocumentIndexTable))
