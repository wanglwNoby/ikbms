...
import { _listKdg } from '../../../common/api/baike'
import styles from './baikeIndex.module.less'
...
class BaikeIndexTable extends React.PureComponent<any, IState> {
        ...
        return (
            <React.Fragment>
                <KdgManagePageHeader
                    ...
                    handleCreate={(): void => this.props.history.push('/baike/create')}
                    handleDelete={(): void => console.log('delete')}
                />
...
const BaikeIndex = Form.create()(withRouter(BaikeIndexTable))

export default BaikeIndex